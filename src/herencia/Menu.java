...
public class Menu {
    ...
    public void PedirOpcion() {
        ...
        if (this.getOpc() == 1) {
            ObjFigura = new AreaCirculo();
            T = this.ObjFigura.CalcularArea();
            this.setTamano(T);
            this.ObjFigura.MostrarAreaCirculo(T);
        }
        if (this.getOpc() == 2) {
            ObjFigura = new VolumenEsfera();
            T = this.ObjFigura.CalcularVolumenEsfera();
            this.setTamano(T);
            this.ObjFigura.MostrarVolumenEsfera(T);
        }
        if (this.getOpc() == 3) {
            ObjFigura = new VolumenCilindro();
            T = this.ObjFigura.CalcularVolumenCilindro();
            this.setTamano(T);
            this.ObjFigura.MostrarVolumenCilindro(T);
        }
        if (this.getOpc() == 4) {
            ObjFigura = new VolumenCono();
            T = this.ObjFigura.CalcularVolumenCono();
            this.setTamano(T);
            this.ObjFigura.MostrarVolumenCono(T);
        }
        if (this.getOpc() == 5) {
